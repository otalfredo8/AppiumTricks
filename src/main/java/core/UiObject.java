...
//        System.out.println(this.locator);
    ...
    //To distinguish between xpaths and locators
    private boolean isXpath(){
        return !locator.contains("UiSelector");
    }

    //To check wether the element exist
    ...
    public String getContentDesc(){
        ...
        return element.getAttribute("content-desc"); //Before: contentDesc
    }
...
//            throw new RuntimeException("Scroll to method can only be used with text attributes and current locator: "+locator+" does not contain any text attributes!");
//        if(isXpath())
