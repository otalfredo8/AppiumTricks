...
public class DriverManager {
    ...
    private static DesiredCapabilities getCaps(String deviceID){
        ...
        DesiredCapabilities caps = new DesiredCapabilities();
            ...
            caps.setCapability("app", "C:\\Users\\alfre\\node_modules_appium_utilities_apks\\tda.apk");
        caps.setCapability("fullReset", "true"); //Uninstall app after test
    ...
    private static URL host(String deviceID) throws MalformedURLException {
        if(hosts == null){
            ...
            hosts.put("fcb9cebe", new URL("http://0.0.0.0:4723/wd/hub"));
            //For when running with multiple devices in parallel
//            hosts.put("xxxxxxxxxx", new URL("http://0.0.0.x:472x/wd/hub"));
    ...
    private static ArrayList<String> getAvailableDevices(){
        ...
        //It loops inside each deviceto check whether or not it has the app installed
