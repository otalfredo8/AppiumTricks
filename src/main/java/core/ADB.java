...
//Utilize adb commands
public class ADB {

    private String ID;

    //Comment this method out to able to exeute the test
    public ADB(String deviceID){ID = deviceID;}

    public static String command(String command){
        //By logging this method, we will know which method used this command
    ...
    //This test require to comment out the ADB constructor, as well as other methods that require this constructor
    /*@Test
    public void test(){
        //CMD: adb shell settings get secure android_id --> f714aea89c5ee2b2
        //CMD: adb devices --> fcb9cebe
        ID = "fcb9cebe";
