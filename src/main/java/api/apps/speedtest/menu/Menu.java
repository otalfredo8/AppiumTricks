...
public class Menu {
    ...
    public Home tapSpeedtest(){
        try{
            MyLogger.log.info("Tapping on the Speedtest LandingActivity Button");
    ...
    public Results tapResults(){
        try{
            MyLogger.log.info("Tapping on the Results LandingActivity Button");
    ...
    public void tapSettings(){
        try{
            MyLogger.log.info("Tapping on the Settings LandingActivity Button");
    ...
    public About tapAbout(){
        try{
            MyLogger.log.info("Tapping on the About LandingActivity Button");
            uiObject.about().tap();
